...
namespace Stardust_Celeste::Utilities {
    ...
    public:
        ...
        /**
         * @brief Logs a message to a logger object. Will not log if the message is below the cutoff level. Locks itself to have threadsafety.
 ...
 */
#define SC_CORE_TRACE(...)  Stardust_Celeste::Utilities::Logger::GetCoreLogger()->trace(__VA_ARGS__)
#define SC_CORE_DEBUG(...)  Stardust_Celeste::Utilities::Logger::GetCoreLogger()->debug(__VA_ARGS__)
#define SC_CORE_INFO(...)   Stardust_Celeste::Utilities::Logger::GetCoreLogger()->info(__VA_ARGS__)
#define SC_CORE_WARN(...)   Stardust_Celeste::Utilities::Logger::GetCoreLogger()->warn(__VA_ARGS__)
#define SC_CORE_ERROR(...)  Stardust_Celeste::Utilities::Logger::GetCoreLogger()->error(__VA_ARGS__)

/**
 * Macros to use the application logger.
 */
#define SC_APP_TRACE(...)   Stardust_Celeste::Utilities::Logger::GetAppLogger()->trace(__VA_ARGS__)
#define SC_APP_DEBUG(...)   Stardust_Celeste::Utilities::Logger::GetAppLogger()->debug(__VA_ARGS__)
#define SC_APP_INFO(...)    Stardust_Celeste::Utilities::Logger::GetAppLogger()->info(__VA_ARGS__)
#define SC_APP_WARN(...)    Stardust_Celeste::Utilities::Logger::GetAppLogger()->warn(__VA_ARGS__)
#define SC_APP_ERROR(...)   Stardust_Celeste::Utilities::Logger::GetAppLogger()->error(__VA_ARGS__)
