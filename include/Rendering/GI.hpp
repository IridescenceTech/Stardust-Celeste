...
/* Blending stuff */
#if SDC_VULKAN
#define GI_SRC_COLOR VK_BLEND_FACTOR_SRC_COLOR
#define GI_ONE_MINUS_SRC_COLOR VK_BLEND_FACTOR_ONE_MINUS_SRC_COLOR
#define GI_SRC_ALPHA VK_BLEND_FACTOR_SRC_ALPHA
#define GI_ONE_MINUS_SRC_ALPHA VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA
#define GI_DST_COLOR VK_BLEND_FACTOR_DST_COLOR
#define GI_ONE_MINUS_DST_COLOR VK_BLEND_FACTOR_ONE_MINUS_DST_COLOR
#define GI_DST_ALPHA VK_BLEND_FACTOR_DST_ALPHA
#define GI_ONE_MINUS_DST_ALPHA VK_BLEND_FACTOR_ONE_MINUS_DST_ALPHA
#else
