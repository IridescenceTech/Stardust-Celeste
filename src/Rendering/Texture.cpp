...
namespace Stardust_Celeste::Rendering {
    ...
    auto TextureManager::load_texture(std::string filename, u32 magFilter, u32 minFilter, bool repeat) -> u32 {
        ...
        tex->minFilter = minFilter;
        ...
        #elif BUILD_PLAT == BUILD_PSP
            unsigned int* dataBuffer = (unsigned int*)memalign(16, tex->pH * tex->pW * 4);
            ...
            unsigned int* swizzled_pixels = (unsigned int*)memalign(16, tex->pH * tex->pW * 4);
